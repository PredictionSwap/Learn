# PredictionSwap  
Protocol infrastructure for prediction markets.


## Decentralised liquidity without inventory.


PredictionSwap solves the structural fragmentation that forces liquid prediction markets to depend on centralised coordination.
